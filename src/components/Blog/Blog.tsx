...
function Blog() {
  return (
    <section className="xs:w-[400px] xs:h-auto">
    <div className="Hero-image-section flex relative items-center justify-center w-full  ">
        ...
        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 bg-[#fff] rounded-[20px] py-[50px] px-[18px] sm:py-[30px] sm:px-[18px] lg:py-[50px] lg:px-[30px] ">
          <div className="flex items-center justify-center gap-[20px]  sm:gap-[20px]   self-stretch flex-col">
            <h2 className="text-[18px] sm:text-[18px]  text-center font-semibold leading-normal">
              Garden Guide
            </h2>
            <p className="text-[14px] sm:text-[14px] xs:text-[12px] font-normal xs:w-[200px] xs:gap-[30px] sm:gap-[40px] sm:w-[400px] md:w-[500px] lg:w-[612px]  text-center  ">
